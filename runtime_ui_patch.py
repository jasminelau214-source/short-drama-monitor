...
def main() -> None:
    ...
    html = replace_once(
        ...
        '<button data-view-button="lifecycle">历史生命周期</button>\n        <button data-view-button="webCollection">Web采集证据</button>',
        'web collection nav',
    )
    html = replace_once(
        html,
    ...
    print('[runtime-ui-patch] applied dashboard scope + Official Web evidence view')
